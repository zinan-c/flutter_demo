...
#ifndef FLUTTER_DEMO_SWIFT_H
#define FLUTTER_DEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_demo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12flutter_demo11AppDelegate")
...
SWIFT_CLASS("_TtC12flutter_demo17MainFlutterWindow")
